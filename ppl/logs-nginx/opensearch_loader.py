...
def main():
    ...
    parser.add_argument(
        '--index-name', default='sso_logs-nginx-prod-2024.05.08',
        help='Index name (default: sso_logs-nginx-prod-2024.05.08)'
    )
    parser.add_argument(
        '--mapping-file', default='benchmark_index_mappings.json',
        help='JSON file containing index mappings (default: benchmark_index_mappings.json)'
    )
    parser.add_argument(
        '--data-file', default='sso_logs-nginx-prod-2024.05.08_docs.ndjson',
